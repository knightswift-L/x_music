...
class FMListDetailPageArguments{
  final String id;
  final String name;
  final String image;

  FMListDetailPageArguments(this.id, this.name, this.image);
}

class FmListDetailPage extends StatefulWidget{
  final FMListDetailPageArguments arguments;
  const FmListDetailPage({super.key, required this.arguments});

  @override
  State<StatefulWidget> createState() {
    return _FmListDetailPageState();
  }
}

class _FmListDetailPageState extends State<FmListDetailPage>{
